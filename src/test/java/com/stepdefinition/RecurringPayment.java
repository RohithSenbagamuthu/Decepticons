...
public class RecurringPayment {
	...
	public void to_launch_the_cyclos_website_and_login_with_the_valid_username_and_password() throws IOException {
	...
	public void to_click_on_banking() throws InterruptedException {
		...
		Thread.sleep(3000);
		// js.executeScript("arguments[0].click();",PaymentsRepository.bankingbtn);
